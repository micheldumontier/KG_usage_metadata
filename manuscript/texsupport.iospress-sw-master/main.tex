...
\begin{table}[ht]
\centering
\caption{Organic Wikidata schema coverage over seven consecutive equal-length (28-day) windows, against the fixed 2017 schema universe (TSE${=}104{,}286$). Coverage is stable at $\sim$4\% despite a $4.7\times$ range in query volume.}
...
\subsubsection{Utility: Usage-Based Ranking for Query Autocompletion}\label{sec:utility}

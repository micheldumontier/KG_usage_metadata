...
%DIF ADD main.tex                                           Fri Jun 12 22:53:11 2026
...
\DIFdelbegin \DIFdel{Similarly, edge thickness and color represent predicate usage,with thinner, light pink edges indicating less usage and thicker, deep purple edges indicating higher usage. Unused schema elements (both nodes and edges)are displayed in gray.The interactive version of this visualization is available online }\footnote{%DIFDELCMD < \url{https://marmhm.github.io/Schema-usage-graph/ } %%%
}%DIFAUXCMD
